...
export function AgentiCatalog() {
  ...
  return (
    <section className="pt-36 pb-24 md:pt-44 md:pb-28 bg-white">
      <div className="container mx-auto px-4 md:px-6">
        {/* Header */}
        <FadeInUp className="text-center max-w-3xl mx-auto mb-12">
          <h1 className="text-3xl md:text-5xl font-heading font-bold text-secondary mb-4">
            Catalogo Agenti AI
          </h1>
          <p className="text-lg text-text-muted">
            50+ agenti pronti per automatizzare ogni aspetto del tuo business
          </p>
        </FadeInUp>
              ...
              <FadeInUp key={agent.id} delay={Math.min(index * 0.05, 0.5)}>
                <div className="bg-white border border-gray-100 p-6 rounded-2xl shadow-sm hover:shadow-xl hover:shadow-brand/5 hover:-translate-y-1 hover:border-brand/30 transition-all duration-300 flex flex-col h-full group">
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="font-heading font-bold text-secondary text-lg leading-tight mb-1 group-hover:text-brand transition-colors">
                        {agent.name}
                      </h3>
        ...
        <FadeInUp delay={0.4} className="mt-16 text-center bg-bg-light border border-brand/20 p-8 rounded-3xl max-w-4xl mx-auto">
          <h2 className="text-xl font-heading font-bold text-secondary mb-3">Non trovi quello che cerchi?</h2>
